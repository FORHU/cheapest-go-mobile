...
async function run() {
    ...
    if (detailedHotel && detailedHotel.detailRooms) {
        console.log('detailRooms count:', detailedHotel.detailRooms.length);
        console.log('detailRooms[0] roomName:', detailedHotel.detailRooms[0]?.roomName);
        console.log('detailRooms[0] photos:', JSON.stringify(detailedHotel.detailRooms[0]?.photos));
        console.log('detailRooms[0] keys:', Object.keys(detailedHotel.detailRooms[0]));
    }
}
